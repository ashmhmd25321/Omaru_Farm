  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-5 py-14 md:py-16">
        ...
        <h1 className="mt-3 font-heading text-4xl text-[#f5efe2] md:text-5xl">Terms of use</h1>
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-white/72 md:text-base">
          <section>
            <h2 className="font-heading text-xl text-[#f5efe2] md:text-2xl">1. Agreement</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-heading text-xl text-[#f5efe2] md:text-2xl">2. Information on this site</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-heading text-xl text-[#f5efe2] md:text-2xl">3. Enquiries &amp; bookings</h2>
            <p className="mt-3">
              Forms and messages on this site are <strong className="text-white/85">requests only</strong> until we confirm by email or phone.
              Availability, pricing, and house rules apply to café visits, stays, and events.
            </p>
          </section>

          <section>
            <h2 className="font-heading text-xl text-[#f5efe2] md:text-2xl">4. Products &amp; store</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-heading text-xl text-[#f5efe2] md:text-2xl">5. Intellectual property</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-heading text-xl text-[#f5efe2] md:text-2xl">6. Liability</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-heading text-xl text-[#f5efe2] md:text-2xl">7. Contact</h2>
            <p className="mt-3">
